...
/**
 * Base class for _libphutil objects. Enforces stricter object semantics than
 * PHP.
 *
 * When a program attempts to write to an undeclared object property, PHP
 * creates the property. However, in _libphutil this is always an error (for
 ...
 * PHP iterates its public members. However, in _libphutil this is always an
