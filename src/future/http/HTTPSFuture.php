...
final class HTTPSFuture extends BaseHTTPFuture
{
   ...
   * is using _libphutil. e.g. in Arcanist, you could add an "ssl_cert" key
  ...
  public function attachFileData($key, $data, $name, $mime_type)
  {
    ...
    public function isReady()
    {
      ...
      //   _libphutil ships with.
      // - Lastly, try the default that _libphutil ships with. If it doesn't
      ...
      if (!$this->getCABundle()) {
          ...
          } elseif (Filesystem::pathExists($caroot.'custom.pem')) {
