...
/**
 * IMPORTANT: Do not call any _libphutil functions in this class, including
...
final class PhutilBootloader
{
    ...
    public function registerLibrary($name, $path)
    {
        ...
        'registered as _libphutil libraries.');
        }
    ...
    // For _libphutil v2 libraries, load all functions when we load the library.
    ...
    public function getLibraryMap($name)
    {
        ...
        case 1:
          throw new Exception(
            '_libphutil v1 libraries are no longer supported.');
        case 2:
