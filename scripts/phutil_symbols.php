...
$args->setSynopsis(<<<EOHELP
    **phutil_symbols.php** [__options__] __path.php__
        ...
        This script is used internally by _libphutil/arcanist to build maps of
        library symbols.
...
foreach ($calls as $call) {
    ...
    if ($call_name === 'call_user_func' ||
      ...
      continue;
        ...
        } elseif ($symbol->getTypeName() === 'n_ARRAY_LITERAL') {
            try {
                $type = 'class';
...
function phutil_symbols_get_builtins()
{
    ...
    'function'  => array_filter(
      array(
        ...
        // These are provided by _libphutil but not visible in the map.
